...
class NeuSwitchNewStyle {
  ...
  @override
  int get hashCode => trackDepth.hashCode ^ activeTrackColor.hashCode ^ inactiveTrackColor.hashCode ^ activeThumbColor.hashCode ^ inactiveThumbColor.hashCode ^ curveType.hashCode ^ thumbDepth.hashCode ^ disableDepth.hashCode;
}
...
class NeuSwitchNew extends StatelessWidget {
  ...
  Color _getTrackColor(NeuThemeData theme) => value == true ? style.activeTrackColor ?? theme.backgroundColor : style.inactiveTrackColor ?? theme.backgroundColor;

  Color _getThumbColor(NeuThemeData theme) => Color(0xFFFFFFFF);
}
