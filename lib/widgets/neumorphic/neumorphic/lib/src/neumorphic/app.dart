...
class _MaterialScrollBehavior extends ScrollBehavior {
  @override
  TargetPlatform getPlatform(BuildContext context) => material_design.Theme.of(context).platform;
...
class _NeuAppState extends State<NeuApp> {
  ...
  RectTween _createRectTween(Rect begin, Rect end) => material_design.MaterialRectArcTween(begin: begin, end: end);
  ...
  Widget build(BuildContext context) {
    Widget result = HeroControllerScope(
      ...
      child: WidgetsApp(
        ...
        pageRouteBuilder: <T>(RouteSettings settings, WidgetBuilder builder) => material_design.MaterialPageRoute<T>(
        ...
        builder: (BuildContext context, Widget child) {
          ...
          return AnimatedNeuTheme(
            ...
            child: widget.builder != null
                ? Builder(
                    builder: (BuildContext context) => widget.builder(context, child),
                  )
                : child,
          );
        },
        ...
        inspectorSelectButtonBuilder:
            (BuildContext context, VoidCallback onPressed) => material_design.FloatingActionButton(
