...
class NeuThemeData {
  ...
  factory NeuThemeData.from({
    ...
    return NeuThemeData(
      ...
      primaryColorBrightness: NeuThemeData.estimateBrightnessForColor(primarySurfaceColor),
      canvasColor: colorScheme.background,
      accentColor: colorScheme.secondary,
      accentColorBrightness: NeuThemeData.estimateBrightnessForColor(colorScheme.secondary),
  ...
  /// Defines the default configuration of button widgets, like [TextButton]
  final ButtonThemeData buttonTheme;

  /// Defines the default configuration of [ToggleButtons] widgets.
  final ToggleButtonsThemeData toggleButtonsTheme;

  /// The default fill color of the [Material] used in [TextButton]s.
  ...
  static final _FifoCache<_IdentityThemeDataCacheKey, NeuThemeData> _localizedThemeDataCache = _FifoCache<_IdentityThemeDataCacheKey, NeuThemeData>(_localizedThemeDataCacheSize);
  ...
  static NeuThemeData localize(NeuThemeData baseTheme, TextTheme localTextGeometry) {
  ...
  /// Performs Linear interpolation with this theme & ThemeData.
  NeuThemeData mixWithThemeData(ThemeData b, double t) => lerpWithThemeData(this, b, t);
  ...
  static NeuThemeData lerpWithThemeData(NeuThemeData a, ThemeData b, double t) {
    ...
    return NeuThemeData.raw(
      ...
      buttonColor: Color.lerp(a.buttonColor, b.buttonColor, t),
      secondaryHeaderColor: Color.lerp(a.secondaryHeaderColor, b.secondaryHeaderColor, t),
      textSelectionColor: Color.lerp(a.textSelectionColor, b.textSelectionTheme.selectionColor, t),
      cursorColor: Color.lerp(a.cursorColor, b.textSelectionTheme.cursorColor, t),
      textSelectionHandleColor: Color.lerp(a.textSelectionHandleColor, b.textSelectionTheme.selectionHandleColor, t),
      backgroundColor: Color.lerp(a.backgroundColor, b.backgroundColor, t),
      dialogBackgroundColor: Color.lerp(a.dialogBackgroundColor, b.dialogBackgroundColor, t),
      indicatorColor: Color.lerp(a.indicatorColor, b.indicatorColor, t),
      hintColor: Color.lerp(a.hintColor, b.hintColor, t),
