...
import 'package:flutter/cupertino.dart' show CupertinoTextThemeData, CupertinoTheme, CupertinoThemeData;
import 'package:flutter/foundation.dart';
import 'package:flutter/widgets.dart';
import 'package:flutter/material.dart' show MaterialLocalizations, ScriptCategory, Theme;
...
class NeuTheme extends StatelessWidget {
  ...
  static NeuThemeData of(BuildContext context, {bool shadowThemeOnly = false}) {
    ...
    if (shadowThemeOnly) {
      if (inheritedTheme == null || inheritedTheme.theme.isNeumorphicAppTheme) return null;
    ...
    return NeuThemeData.localize(theme, theme.typography.geometryThemeFor(category));
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<NeuThemeData>('data', data, showName: false));
  }
}
...
class _InheritedTheme extends InheritedTheme {
  ...
  Widget wrap(BuildContext context, Widget child) {
    ...
    return identical(this, ancestorTheme) ? child : NeuTheme(data: theme.data, child: child);
  }
...
class NeumorphicThemeDataTween extends Tween<NeuThemeData> {
  ...
  /// filled in later.
  NeumorphicThemeDataTween({NeuThemeData begin, NeuThemeData end}) : super(begin: begin, end: end);
...
class _AnimatedThemeState extends AnimatedWidgetBaseState<AnimatedNeuTheme> {
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    ...
    _data = visitor(_data, widget.data, (value) => NeumorphicThemeDataTween(begin: value));
    _mData = visitor(_mData, widget.data.themeData, (value) => NeumorphicThemeDataTween(begin: value));
    assert(_data != null);
    assert(_mData != null);
  }

  @override
  Widget build(BuildContext context) => NeuTheme(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(DiagnosticsProperty<NeumorphicThemeDataTween>('data', _data, showName: false, defaultValue: null));
  }
}
...
class NeuBasedCupertinoTheme extends CupertinoThemeData {
  ...
  @override
  Brightness get brightness => _cupertinoOverrideTheme.brightness ?? _neuThemeData.brightness;

  @override
  Color get primaryColor => _cupertinoOverrideTheme.primaryColor ?? _neuThemeData.colorScheme.primary;

  @override
  Color get primaryContrastingColor => _cupertinoOverrideTheme.primaryContrastingColor ?? _neuThemeData.colorScheme.onPrimary;

  @override
  Color get scaffoldBackgroundColor => _cupertinoOverrideTheme.scaffoldBackgroundColor ?? _neuThemeData.scaffoldBackgroundColor;
  ...
  @override
  CupertinoThemeData resolveFrom(BuildContext context, {bool nullOk = false}) => NeuBasedCupertinoTheme._(
        _neuThemeData,
